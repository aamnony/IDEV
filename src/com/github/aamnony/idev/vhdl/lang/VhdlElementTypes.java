...
public class VhdlElementTypes {
    ...
    public static final TokenSet STATEMENTS = TokenSet.create(
            VhdlTypes.ASSERTION_STATEMENT, VhdlTypes.REPORT_STATEMENT, VhdlTypes.BLOCK_STATEMENT, VhdlTypes.CASE_STATEMENT, VhdlTypes.CASE_STATEMENT_ALTERNATIVE,
            VhdlTypes.COMPONENT_INSTANTIATION_STATEMENT, VhdlTypes.CONCURRENT_ASSERTION_STATEMENT, VhdlTypes.CONCURRENT_PROCEDURE_CALL_STATEMENT,
            VhdlTypes.CONCURRENT_SIGNAL_ASSIGNMENT_STATEMENT, VhdlTypes.EXIT_STATEMENT, VhdlTypes.GENERATE_STATEMENT, VhdlTypes.IF_STATEMENT,
            VhdlTypes.LOOP_STATEMENT, VhdlTypes.NEXT_STATEMENT, VhdlTypes.NULL_STATEMENT, VhdlTypes.PROCEDURE_CALL_STATEMENT, VhdlTypes.PROCESS_STATEMENT,
            VhdlTypes.RETURN_STATEMENT, VhdlTypes.SIGNAL_ASSIGNMENT_STATEMENT, VhdlTypes.VARIABLE_ASSIGNMENT_STATEMENT, VhdlTypes.WAIT_STATEMENT
    );
